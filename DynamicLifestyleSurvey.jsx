...
export default function DynamicLifestyleSurvey() {
  ...
  const payload = {
    ...
    bilirubin: extracted.bilirubin ?? null, 
    alt: extracted.alt ?? null,
    ast: extracted.ast ?? null, 
    platelets: extracted.platelets ?? null,
    albumin: extracted.albumin ?? null, 
    globulin: extracted.globulin ?? null,
    alcohol: data.alcohol ?? null, 
    smoking: data.smoking ?? null,
    bmi: data.bmi ? Number(data.bmi) : null,
    diabetes: data.diabetes ?? null,
    hbv: data.hepatitis === 'Hepatitis B' || data.hepatitis === 'Both',
    hcv: data.hepatitis === 'Hepatitis C' || data.hepatitis === 'Both',
    hepatitis: data.hepatitis ?? null,
    family_history_liver: data.familyHistory ?? null,
    source: 'ocr',
  };
